    ...
    contentScripts: [
      {
        matches: [
          ...
          'https://*.searx.io/search',
          'https://*.searx.de/search',
          'https://*.searx.fr/search',
          'https://*.searx.tf/search',
          'https://*.searx.fi/search',
          'https://*.searx.pt/search',
          'https://*.searx.info/search',
          'https://*.searx.bar/search',
          'https://*.searx.com/search',
          'https://searx.tiekoetter.com/search',
          'https://paulgo.io/search',
          'https://northboot.xyz/search',
          'https://search.disroot.org/search',
          'https://anon.sx/search',
          'https://s.zhaocloud.net/search',
          'https://searx.bissisoft.com/search',
          'https://procurx.pt/search',
          'https://searx.rasp.fr/search',
          'https://searx.tuxcloud.net/search',
          'https://searx.mha.fi/search',
          'https://searx.zackptg5.com/search',
          'https://searx.gnous.eu/search',
          'https://darmarit.org/searx/search',
          'https://suche.uferwerk.org/search',
          'https://searx.run/search',
          'https://search.antonkling.se/search',
          'https://searx.mxchange.org/search',
          'https://jsearch.pw/search',
          'https://search.neet.works/search',
          'https://search.zdechov.net/search',
