...
exportAsMessages('_locales/es/messages.json', {
  ...
  options_syncFeatureDescription: 'Puedes sincronizar las listas negras entre tus dispositivos a través de una nube.',
  ...
  options_subscriptionFeatureDescription: 'Si añade una suscripción, las listas negras se descargarán regularmente desde la URL especificada.',
