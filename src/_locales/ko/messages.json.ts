...
export default exportAsMessages({
  ...
  error: "오류: $1",
  unauthorizedError:
    "계정 인증에 실패했습니다. 동기화 중단 후 다시 설정해 주세요.",
  cancelButton: "취소",
  okButton: "확인",
  ...
  options_resetSettingsLabel: "설정 초기화",
  options_resetSettingsButton: "초기화",
  options_resetSettingsConfirmation: "정말 설정을 초기화 할까요?",
