...
export default exportAsMessages({
  ...
  options_enableRulesetSubscriptionURL: "启用规则集订阅链接",
  options_enableRulesetSubscriptionURLDescription:
    "将 $1 重定向到此页面以添加规则集订阅。",
  options_enableRulesetSubscriptionURLButton: "启用",
  options_rulesetSubscriptionURLIsEnabled: "规则集订阅链接已启用",
  ...
  options_resetSettingsLabel: "初始化设置",
  options_resetSettingsButton: "初始化",
  options_resetSettingsConfirmation: "确定要初始化设置吗？",
  ...
  options_experimentalSectionTitle: "实验性功能",
  options_serpInfoLabel: "SERPINFO",
  options_openSerpInfoOptionsButton: "选项",
  options_serpInfoBasicSettingsSection: "基本设置",
  options_enableSerpInfo: "启用 SERPINFO",
  options_enableSerpInfoSubscriptionURL: "启用 SERPINFO 订阅链接",
  options_enableSerpInfoSubscriptionURLDescription:
    "将 $1 重定向到此页面以添加 SERPINFO。",
  options_enableSerpInfoSubscriptionURLButton: "启用",
  options_serpInfoSubscriptionURLIsEnabled: "SERPINFO 订阅链接已启用",
  options_accessPermissionLabel: "更新访问权限",
  options_accessPermissionDescription:
    "如果 SERPINFO 设置从其他设备同步或以其他方式更改，您可能需要更新访问权限。",
  options_accessPermissionButton: "更新",
  options_remoteSerpInfoSection: "SERPINFO 列表",
  options_remoteSerpInfoVersion: "版本",
  options_remoteSerpInfoLastModified: "最后修改时间",
  options_remoteSerpInfoHomepage: "主页",
  options_showRemoteSerpInfoButton: "显示",
  options_removeRemoteSerpInfoButton: "移除",
  options_updateAllRemoteSerpInfoButton: "立即更新",
  options_addRemoteSerpInfoButton: "添加",
  options_addRemoteSerpInfoDialog_title: "添加 SERPINFO",
  options_addRemoteSerpInfoDialog_urlLabel: "URL",
  options_addRemoteSerpInfoDialog_addButton: "添加",
  options_userSerpInfoSection: "我的 SERPINFO",
  options_userSerpInfoDocumentationLink: "文档",
