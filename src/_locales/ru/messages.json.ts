...
export default exportAsMessages({
  ...
  error: "Ошибка: $1",
  unauthorizedError:
    "Ошибка авторизации. Пожалуйста, выключите синхронизацию и включите снова.",
  cancelButton: "Отмена",
  okButton: "ОК",
  ...
  options_blacklistLabel:
    "Выбранные сайты не будут отображаться в поисковой выдаче Google",
  ...
  options_importBlacklistDialog_helper:
    "Вставьте список доменов из Personal Blocklist.",
  ...
  options_turnOnSyncDialog_useAltFlow:
    "Открыть страницу аутентификации в новой вкладке",
  ...
  clouds_dropboxSyncDescription:
    'Файл будет создан в папке "/Apps/uBlacklist/".',
