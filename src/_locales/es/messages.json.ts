...
export default exportAsMessages({
  ...
  error: "Error: $1",
  unauthorizedError:
    "No autorizado. Por favor, desactive la sincronización y vuelva a activarla.",
  ...
  options_importBlacklistDialog_fromPB:
    "Importar desde la lista de bloqueo personal",
  ...
  options_dialogTheme:
    'Tema del diálogo "Bloquear este sitio" en los resultados de búsqueda',
