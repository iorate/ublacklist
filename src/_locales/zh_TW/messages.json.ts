...
export default exportAsMessages({
  ...
  options_importBlacklistDialog_helper:
    "貼上從 Personal Blocklist 匯出的網域清單。",
  ...
  options_hideBlockButtonsLabel: "隱藏封鎖按鈕",
  ...
  options_highlightDescription:
    "若要使用「顏色 N」來強調顯示某筆搜尋結果，請在規則前加上「@N」。",
  ...
  options_syncFeatureUpdated:
    "同步功能已更新。若要繼續使用同步功能，請點選「開啟同步」按鈕。",
  options_syncFeature: "雲端同步",
  options_syncFeatureDescription:
    "可透過雲端服務，在您的不同裝置間同步封鎖清單資料。",
  ...
  options_enableRulesetSubscriptionURL: "啟用規則集訂閱連結",
  options_enableRulesetSubscriptionURLDescription:
    "將 $1 重定向至此頁以新增規則集訂閱。",
  options_enableRulesetSubscriptionURLButton: "啟用",
  options_rulesetSubscriptionURLIsEnabled: "規則集訂閱連結已啟用",
  options_subscriptionFeature: "訂閱封鎖清單",
  options_subscriptionFeatureDescription:
    "如果您加入訂閱項目，將定期從指定的網址下載封鎖清單。",
  ...
  options_resetSettingsLabel: "重設設定",
  options_resetSettingsButton: "重設",
  options_resetSettingsConfirmation: "確定要將重設設定嗎？",
  ...
  options_experimentalSectionTitle: "實驗功能",
  options_serpInfoLabel: "SERPINFO",
  options_openSerpInfoOptionsButton: "選項",
  options_serpInfoBasicSettingsSection: "基本設定",
  options_enableSerpInfo: "啟用 SERPINFO",
  options_enableSerpInfoSubscriptionURL: "啟用 SERPINFO 訂閱連結",
  options_enableSerpInfoSubscriptionURLDescription:
    "將 $1 重定向至此頁以新增 SERPINFO。",
  options_enableSerpInfoSubscriptionURLButton: "啟用",
  options_serpInfoSubscriptionURLIsEnabled: "SERPINFO 訂閱連結已啟用",
  options_accessPermissionLabel: "更新存取權限",
  options_accessPermissionDescription:
    "如果 SERPINFO 設定是從另一個裝置同步或以其他方式更改，您可能需要更新存取權限。",
  options_accessPermissionButton: "更新",
  options_remoteSerpInfoSection: "SERPINFO 清單",
  options_remoteSerpInfoVersion: "版本",
  options_remoteSerpInfoLastModified: "最後修改",
  options_remoteSerpInfoHomepage: "首頁",
  options_showRemoteSerpInfoButton: "顯示",
  options_removeRemoteSerpInfoButton: "移除",
  options_updateAllRemoteSerpInfoButton: "立即更新",
  options_addRemoteSerpInfoButton: "新增",
  options_addRemoteSerpInfoDialog_title: "新增 SERPINFO",
  options_addRemoteSerpInfoDialog_urlLabel: "URL",
  options_addRemoteSerpInfoDialog_addButton: "新增",
  options_userSerpInfoSection: "我的 SERPINFO",
  options_userSerpInfoDocumentationLink: "文檔",
  options_saveUserSerpInfo: "保存",
  clouds_googleDriveSync: "與 Google Drive 同步",
  clouds_googleDriveSyncDescription:
    "同步檔案將會儲存在一個使用者不可見的應用程式資料夾中。",
