...
export type MessageName0 =
  ...
  | "content_unhighlightSiteLink"
  | "popup_blockSiteTitle"
  | "popup_unblockSiteTitle"
  | "popup_highlightSiteTitle"
  | "popup_unhighlightSiteTitle"
  | "popup_details"
  | "popup_propertiesLabel"
  | "popup_addedRulesLabel"
  | "popup_removedRulesLabel"
  | "popup_noRules"
  | "popup_blockSiteButton"
  | "popup_unblockSiteButton"
  | "popup_highlightSiteButton"
  | "popup_unhighlightSiteButton"
  | "popup_changeActionLabel"
  ...
  | "options_skipBlockDialogDescription"
  ...
  | "options_turnOnSyncDialog_initialSyncLabel"
  | "options_turnOnSyncDialog_initialSyncLastWriteWins"
  | "options_turnOnSyncDialog_initialSyncUseLocal"
  | "options_turnOnSyncDialog_initialSyncUseRemote"
  | "options_turnOffSync"
  | "options_syncResult"
  | "options_syncNever"
  | "options_syncRunning"
  ...
  | "options_syncIntervalInMinutes"
  | "options_increaseIntervalButton"
  | "options_decreaseIntervalButton"
  ...
  | "options_renameSubscriptionMenu"
  | "options_removeSubscriptionMenu"
  | "options_renameSubscriptionDialog_title"
  | "options_renameSubscriptionDialog_renameButton"
  | "options_updateAllSubscriptionsNowButton"
  | "options_addSubscriptionDialog_title"
  | "options_addSubscriptionDialog_urlLabel"
  | "options_addSubscriptionDialog_typeLabel"
  | "options_addSubscriptionDialog_typeRuleset"
  | "options_addSubscriptionDialog_typeDomains"
  | "options_addSubscriptionDialog_nameLabel"
  | "options_addSubscriptionDialog_nameDescription"
  | "options_addSubscriptionDialog_addButton"
  | "options_showSubscriptionDialog_blacklistLabel"
  | "options_updateIntervalInDays"
  ...
  | "clouds_oneDriveSync"
  | "clouds_oneDriveSyncDescription"
  | "clouds_oneDriveSyncTurnedOn"
  | "clouds_webdavSync"
